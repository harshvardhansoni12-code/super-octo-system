...
const navItems = ["Overview", "Members", "Reports", "System health"];
      ...
      current.map((member, memberIndex) =>
        memberIndex === index
          ? [
              ...
              member[1],
              member[2],
              member[3] === "Active" ? "Pending" : "Active",
            ]
          : member,
      ),
    );
        ...
        <section className="min-w-0 flex-1 px-5 py-6 sm:px-8 sm:py-8">
          <div className="mb-5 flex items-center justify-between sm:hidden">
            ...
            <div className="flex gap-2">
              ...
              <span className="flex size-8 items-center justify-center rounded-full bg-[#214a38] text-xs font-bold text-white">
                A
              </span>
            </div>
          </div>
          ...
          <section className="mt-7 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
            {[
              ...
              >
                ...
                <p className="mt-2 text-xs text-[#78907c]">{note}</p>
              </div>
            ))}
          </section>
          <div className="mt-5 grid gap-5 xl:grid-cols-[1.2fr_0.8fr]">
            <section className="rounded-2xl border border-[#dce4d8] bg-white p-5 sm:p-6">
              <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-center">
                <div>
                  ...
                  <h2 className="mt-1 text-xl font-semibold">Members</h2>
                </div>
                        ...
                        >
                          <td className="py-3">
                            <span className="flex items-center gap-3">
                              ...
                              <span>
                                <b className="block font-medium">{member[0]}</b>
                          ...
                          <td className="py-3 text-[#718078]">{member[2]}</td>
                          <td className="py-3">
                            <span
                              className={`rounded-full px-2 py-1 text-[10px] font-bold ${member[3] === "Active" ? "bg-[#e8f2df] text-[#5b823e]" : "bg-[#fff2cf] text-[#9a791f]"}`}
                            >
                              {member[3]}
                            </span>
                          </td>
                          <td className="py-3 text-right">
                            <button
                              ...
                              className="text-xs font-semibold text-[#5c7c4f] hover:underline"
                            >
                              {member[3] === "Active" ? "Pause" : "Activate"}
                            </button>
                          </td>
                        </tr>
                      );
            ...
            <section className="rounded-2xl border border-[#dce4d8] bg-[#214a38] p-5 text-white sm:p-6">
              ...
              <div className="mt-8 flex h-32 items-end justify-between gap-2">
                {[42, 58, 51, 74, 65, 88, 78].map((height, index) => (
                  <div
                    key={index}
          ...
          <section className="mt-5 rounded-2xl border border-[#dce4d8] bg-white p-5 sm:p-6">
            <div className="flex items-center justify-between">
              ...
              <button className="flex items-center gap-1 text-xs font-semibold text-[#5c7c4f]">
            ...
            <div className="mt-4 grid gap-3 md:grid-cols-3">
              {[
                ...
                <div key={title} className="rounded-xl bg-[#f7f9f5] p-3">
                  <div className="flex items-center justify-between">
                    <span className="flex size-7 items-center justify-center rounded-full bg-[#dcebc9]">
                      <Check className="size-3.5 text-[#5b823e]" />
                    </span>
                    <span className="text-[10px] text-[#92a095]">{time}</span>
                  </div>
                  <p className="mt-3 text-sm font-medium">{title}</p>
                  <p className="mt-1 text-xs text-[#92a095]">{source}</p>
                </div>
              ))}
            </div>
          </section>
